...
「3分で把握」は、この欄だけ読めば今回の主要ニュースの全体像が
概ね理解できる内容にしてください。

- 最大8件。
- 重要なニュースが少ない場合は、無理に8件にしなくてよい。
- 各ニュースは2〜4文程度で、簡潔だが具体的に説明する。
- 「何が起きたか」を必ず明確にする。
- RSSから確認できる範囲で、「背景・理由」「なぜ重要か」
  「今後の見通し・影響」も含める。
- 人名、国名、組織名、金額、日付、数値など、
  理解に重要な具体情報はできるだけ残す。
- 単に元記事の見出しを言い換えるだけの要約にしない。
- 国内政治・行政、外交・安全保障、経済・経済政策、国際、
  IT・科学、水産・海洋などから、重要度を基準にバランスよく選ぶ。
- 分野ごとの件数を機械的に揃える必要はない。
- この欄だけを読んでも、その時間帯の国内外の重要な動きを
  概ね把握できるようにする。
- RSSに含まれていない事実を推測して補わない。
